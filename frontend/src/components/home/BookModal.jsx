    ...
    return (
        <div className='fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center' onClick={onClose}>
            <div onClick={(event) => event.stopPropagation()} className='w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative'>
                ...
                <p className='my-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam veniam molestias, quasi nostrum iusto nemo obcaecati porro facere vel expedita dolores? Nulla nostrum reprehenderit deserunt quasi laborum veritatis. Culpa, ex.</p>
            </div>
        </div>
    )
}
